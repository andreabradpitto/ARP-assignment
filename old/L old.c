    ...
    */
    ...
    while (1)
    {
        ...
        case 0:
            ...
            break;
        case 1:
            syslog(LOG_INFO, "\n%lu%s", msg.timestamp, " - from S - continue command issued");
            break;
        case 99:
            syslog(LOG_INFO, "\n%lu%s%f%s", msg.timestamp, " - from G - sent value: ", msg.value); //l'ultimo placeholder ci va?
            break;
        case 3:
            //log print in output file
            printf("\n[User asked print of logfile]");
